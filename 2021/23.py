...
costs = [[abs(coords[i][0] - coords[j][0]) + abs(coords[i][1] - coords[j][1]) for i in range(15)] for j in range(15)]
...
def return_amphipods_home(state, costs, habitat, passes):
        ...
        for s in d[c]:
            ...
            for pos, amphipod in enumerate(s):
                ...
                for target in range(size):
                    ...
                    if any([pos in habitat[a] and target in habitat[a] for a in multiplier]): continue
...
return_amphipods_home(state, costs, habitat, passes)
